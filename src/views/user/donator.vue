  ...
  <div class="app-container">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="捐赠者名">
              <el-input v-model="searchObj.username" style="width: 100%" placeholder="根据捐赠者姓名搜索" />
            </el-form-item>
          </el-col>
        </el-row>
    ...
    >
      ...
      <el-table-column label="操作" width="400" align="center">
        <template slot-scope="scope">
          <el-button icon="el-icon-edit" size="mini" title="查看捐赠流水" plain @click="showDonation(scope.row.id)">查看捐赠流水</el-button>
