<template>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="用户名称">
              <el-input style="width: 100%" v-model="searchObj.username" placeholder="用户名称"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row style="display:flex">
          <el-button type="primary" icon="el-icon-search" size="mini" :loading="loading" @click="fetchData()">搜 索</el-button>
    ...
    <el-table
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="edit(scope.row.id)" title="修改">修 改</el-button>
